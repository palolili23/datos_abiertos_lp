...
lolilop <- taza_alfab %>% 
  ...
  geom_point(aes(x = prov, y = Niñas), color = "#d11141", size = 1.5) +
  geom_point(aes(x = prov, y = Niños), color = "#00b159", size = 1.5) +
  coord_flip() +
  ...
  theme(axis.text.y=element_blank(),
        axis.ticks.y=element_blank()) +
  labs(
    title = "Taza de alfabetización promedio por provincia para niñas y niños mayores a 15 años \n\n",
    caption = "Fuente: Censo 2012, INDEC",
    x= "Provincias",
    y = ""
  ) 
